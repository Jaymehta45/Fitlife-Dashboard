...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-purple-100 via-violet-100/80 to-fuchsia-100/80 backdrop-blur-sm shadow-2xl border-r border-purple-300 transform transition-transform duration-300 ease-in-out
        lg:translate-x-0 lg:static lg:inset-0
        ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}
      `}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center px-6 py-6 border-b border-purple-300/40 bg-gradient-to-r from-purple-500/20 via-violet-500/20 to-fuchsia-500/20">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold text-neutral-900">FitLife</span>
            </div>
          </div>
          ...
          {/* User info */}
          <div className="px-6 py-5 border-t border-purple-300/40 bg-gradient-to-r from-purple-100/60 via-violet-100/60 to-fuchsia-100/60">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg">
                <span className="text-base font-bold text-white">AJ</span>
              </div>
